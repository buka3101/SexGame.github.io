    ...
    const contentArrays = {
        woman: {
            easy: [
				...
				'11. В течении 1 минуты ты должна целовать язык Егора, обкусывай его и обсасывай',
				'12.  Возьми палец Егора в рот и изображай оральные ласки, рассказывая ему о том, как ты будешь сосать его член'
            ],
            middle: [
				...
				'14. Встань около стены и прогнись, чтобы показать ему свои дырочки, он подходит сзади и ты берешь его член и сама водишь по вагине, анусу и иногда можешь вставить только по головку. При этом рассказывай как ты хочешь чтобы он тебя жёстко трахнул',
				'15. Займись гимнастикой перед лицом Егора полностю голая (подводи вагину к лицу, грудь, попу, анус)',
				'16. Даша, поставь камеру перед вами и положи Егора в позу "Чайный пакетик", и жадно соси его член на протяжении 1 минуты',
				'17. Пусть Егор встанет, а ты встань перед ним, дрочи ему член рукой, а ртом играйся с его сосками'
            ],
            hard: [
				...
				'13. Встань перед Егор на колени и умоляй его тебя трахнуть в горло, он может давать тебе пощечины и плевать в рот (Если он захочет, то трахнет в рот). 1 минута.'
            ]
        },
        man: {
            easy: [
				...
				'11. Посади Дашу спиной к себе, и пальцем рисуй слово на спине по одной букве (минимум 5 букв в слове), за каждый неправильный ответ буквы пощёчина или шлепок по попе, за каждый правильный ответ поцелуй и комплимент Даше',
				'12. Возьми лёд в рот и поцелуй в засос Дашу, вы должны передавать этот кусочек льда друг другу в рот. (В это время можете трогать интимные места друг друга через одежду)'
            ],
            middle: [
				...
				'14. Егор, поставь камеру перед вами и поставь Дашу в позу "Superwoman", и жадно лижи её вагину на протяжении 1 минуты',
				'15. Оставь засосы Даше на всех частях тела (Поставь на обе груди, внутренней части бедер, рядом с вагиной, животе, попе, спине)',
				'16. Сделай куни Даше с пальцами внутри, Даша не должна не издавать ни звука, если она не выдержит (или просто захочет, чтобы ты её наказал) и начнёт стонать, ты должен её отшлепать. 1 минута',
                '17. Положи Дашу на живот и води членом между её ягодицами, проводи по вагине и анусу, но не входи внутрь. Можешь также её целовать. 1 минуту',
            ],
            hard: [
